  ...
  toggleEstado(certificado: Certificado) {
    if (certificado.id) {
      ...
      const dialogRef = this.dialog.open(ConfirmDialogComponent, {
        width: '400px',
        data: {
          message: `¿Está seguro que desea ${action} el certificado <br><strong style="font-size: 1.25em; color: #1976d2; display: block; margin-top: 8px;">${certificado.codigoCertificado}</strong>?`
        }
      });
